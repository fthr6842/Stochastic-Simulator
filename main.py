...
if __name__ == "__main__":
    ...
    call_price_GBM, put_price_GBM = mc_option_price(array_GBM, K, r, T)
    print(f"Call: {call_price_GBM}; Put: {put_price_GBM} for GBM.")
    
    # Heston model 模擬數據與繪圖
    ...
    call_price_HM, put_price_HM = mc_option_price(array_HM, K, r, T)
    print(f"Call: {call_price_HM}; Put: {put_price_HM} for Heston model.")
